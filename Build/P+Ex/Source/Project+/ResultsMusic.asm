...
ClassicResultsTable:
	half[128] | # Slots
		...
		0x0000, 0x0000, 0x2772, 0x0000, | # "FighterEX60", "FighterEX61", Sceptile ("FighterEX62"), "FighterEX63"
		0x0000, 0x0000, 0x0000, 0x0000, | # "FighterEX64", "FighterEX65", "FighterEX66", "FighterEX67"
		0x0000, 0x0000, 0x2709, 0x2709, | # "FighterEX68", "FighterEX69", Red Alloy Ex ("FighterEX6A"), Blue Alloy Ex ("FighterEX6B")
		0x2709, 0x2709, 0x0000, 0x0000, | # Yellow Alloy Ex ("FighterEX6C"), Green Alloy Ex ("FighterEX6D"), "FighterEX6E", "FighterEX6F"
